...
export const RoomDetail = (req, res) => {
  res
    .status(200)
    .json({ message: "All Rooms fetched Successfully", List_of_Rooms: rooms });
};
...
export const CreateRoom = (req, res) => {
  ...
  res
    .status(200)
    .json({ message: "create new Room Successfully", New_Room: rooms });
};
...
export const BookRoom = (req, res) => {
  ...
  if (!room) {
    ...
    let BookingDate = BookingRoom.filter((room) => {
    ...
    if (BookingRoom > 0) {
      ...
      return res
        .status(400)
        .json({ message: "Room Booked Successfully", BookedRoom: BookingRoom });
    }
  }
};
...
export const AllCustomerBookedData = (req, res) => {
  ...
  res
    .status(200)
    .json({
      message: "All Customer and their BookedRoom details",
      customerData,
    });
};
...
export const customerBookingDetails = (req, res) => {
  ...
  BookingRoom.forEach((booking) => {
    ...
    customerBooking[customer_name].push({
      roomId,
      booking_date,
      arrival,
      departure,
