...
import hallRouter from "./Routers/Hall.routers.js";
...
app.get("/", (req, res) => {
  res.status(200)
    .send(`<div style="text-align: center; background-color:lightblue;  padding: 10px;"><h1>Welcome to: The Enchanted Hall Booking</h1></div>
          <div>
          <ul>
          <li>
